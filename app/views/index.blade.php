...
@extends('layouts.default')
	...
	<div class="col-md-1">
	    ...
	    <!--<div style="height:90px;width:90px;border: 1px solid #528FBE;margin-bottom:15px;">
	    </div>
	    <div style="height:90px;width:90px;border: 1px solid #528FBE;margin-top:18px;margin-bottom:15px;">
	    </div>
	    <div style="height:90px;width:90px;border: 1px solid #528FBE;margin-top:18px;margin-bottom:15px;">
	    </div>
	    <div style="height:90px;width:90px;border: 1px solid #528FBE;margin-top:18px;margin-bottom:15px;">
